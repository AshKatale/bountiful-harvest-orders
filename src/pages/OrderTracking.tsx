...
const OrderTracking = () => {
  ...
  const handleBuyerSearch = (e: React.FormEvent) => {
    e.preventDefault();
        ...
        <div className="relative">
          <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
            <div
              ...
              className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-agro"
            ></div>
          </div>
            ...
            {steps.map((step, i) => (
              <div
                ...
                className={`flex flex-col items-center ${
                  i <= currentStep ? "text-agro" : "text-gray-400"
                }`}
              >
                <div
                  className={`w-8 h-8 rounded-full border-2 flex items-center justify-center ${
                    i <= currentStep
                      ? "border-agro bg-agro-light/20"
                      : "border-gray-300"
                  }`}
                >
